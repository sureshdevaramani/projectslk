...
<body>
    ...
    <div class="col-md-8 card" style="margin-top:100px;margin-left:20px;margin-bottom:10px;border-color:#0094ff;">
         ...
         <h4><span class="badge badge-secondary ">Premium Calculator </span></h4>
    ...
    <select runat="server" class="form-control" id="policy">
      <option value="1" >Accidental Cover</option>
      <option value="2">Third Party Cover</option>
