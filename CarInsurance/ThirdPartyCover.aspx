<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ThirdPartyCover.aspx.cs" Inherits="ThirPartyCover" %>
...
<body>
    ...
    <div class="col-md-8 card" style="margin-top:100px;margin-left:20px;margin-bottom:10px;border-color:#0094ff;">
         ...
         <h4><span class="badge badge-secondary ">Premium Calculator For Third Party Cover Policy</span></h4>
